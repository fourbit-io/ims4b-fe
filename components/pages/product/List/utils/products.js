...
import { productTableHeader as tableHeaders, productModal, productsTable } from "@/contents/bengali";
...
export const products = () => {
    ...
    const renderActions = (row) => (
      <div className="flex items-center gap-2 justify-center">
        ...
        <BsTrash
          ...
          onClick={() => {setDeleteModal(true); setProductItem(row)}}
        />
    ...
    return {router, tableColumns, tableHeaders, pageTitle, productLists, setProductLists, renderActions, deleteModal, setDeleteModal, deleteModalContent, deleteAction, dltIsLoading, productItem}
}