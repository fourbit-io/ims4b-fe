...
export const Component = forwardRef((props, ref) => {
  const { id, date, userName, items, remark } = props;

  return (
    <div ref={ref} className="mt-6 px-2">
      <div className="flex justify-end">
        <p className="border p-3 w-[200px] ">চাহিদা পত্রঃ {convertNumber(id)}</p>
      </div>
      ...
      <div className=" px-16  my-5">
        <p className="mb-2">
          ...
          পদবী {userName} এর ব্যবহারের জন্য নিম্নে বর্ণিত মালামালগুলো সরবরাহ
        ...
        <div className="border-2 my-6">
          ...
          {items?.map((item, id) => (
            <div key={id} className="grid grid-cols-4  text-center  divide-x-2">
        ...
        <div className="my-10">
          ...
          <p>
            মালামালগুলো {convertDate(date)} তারিখে সরবরাহ করে নিম্নেবর্ণিত রেজিস্টার ও পৃষ্ঠায়
            লিপিবদ্ধ করা হলো।
          </p>
          <p>রেজিস্টার নং………………………………………………………………</p>
          <p>পৃষ্ঠা নং……………………………………………………………………</p>
